...
// Versie: 5.0.0 — Login persistentie fix + Push verbeterd

const CACHE_NAME = 'gluco-buddy-v5';
const RUNTIME_CACHE = 'gluco-buddy-runtime-v5';
...
console.log('[SW] Gluco Buddy Service Worker v5.0 geladen ✓');
